...
from config import (
    ...
    WHITE, RED, GREEN, YELLOW, BLUE, ORANGE, GRAY
)
from sprites import Basket, FallingItem, GoldenApple, Star
from effects import Particle, StarBurst, GOLD, BRIGHT_GOLD
from ui import draw_text, draw_button, draw_hud, ComboDisplay
...
class Game:
    ...
    def _draw_hud(self):
        draw_hud(self.screen, self.score, self.high_score, self.level,
                 self.level_time, self.health, self.music_on)
